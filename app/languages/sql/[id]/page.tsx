...
const CodeBlock = ({ children, language = 'sql' }: { children: string, language?: string }) => {
...
export default function SqlTheoryPage() {
  ...
  const [theoryData, setTheoryData] = useState<SqlTheoryData | null>(null)
  ...
  useEffect(() => {
    const fetchTheoryData = async () => {
      try {
        ...
        console.error('Error fetching SQL theory data:', err)
        setError('Failed to load SQL theory content. Please try again.')
      } finally {
        setLoading(false)
      }
    }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-mono text-lg mb-6">Loading SQL theory content...</p>
          <LoadingProgressBar />
        </div>
      </div>
    )
  ...
  if (!theoryData) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="text-center">
          <div className="text-6xl mb-6">🙀</div>
          <p className="text-gray-600 font-mono text-lg">SQL theory content not found</p>
        </div>
      </div>
    )
  }
          ...
          <div className="max-w-7xl mx-auto flex justify-between items-center px-4">
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-light text-blue-600">SQL Theory</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12 bg-white shadow-sm border p-8">
          ...
          <p className="text-xl text-gray-600 font-light mb-4">
            Master SQL databases, one query at a time
          </p>
          <p className="text-base text-gray-400 font-light">
            Data is purr-fect when organized 🗃️
          </p>
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <div className="flex gap-4 text-sm text-gray-500 justify-center items-center">
              ...
              <span>🗃️ {sectionStats.withCode} with SQL</span>
              <span>📊 {sectionStats.withComplexity} with analysis</span>
